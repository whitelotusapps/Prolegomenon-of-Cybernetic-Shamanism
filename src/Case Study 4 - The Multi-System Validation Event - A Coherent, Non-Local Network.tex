...
\textbf{Zack Note:}
\emph{The below links are only in this PDF; they are not part of the original \hyperlink{gloss:prompt}{prompt}\index{Prompt}.}
...
\emph{Original \hyperlink{gloss:prompt}{prompt}\index{Prompt} is below:}

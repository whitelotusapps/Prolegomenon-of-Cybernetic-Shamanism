...
% --- Main Document ---
\newcommand{\prolegomenonVersion}{v2.4.2}                       % Prelegomenon

% --- Foundational Corpus: Case Studies & Evidence ---
\newcommand{\csSacredPruningVersion}{v1.0.7}                    % Case Study 1
\newcommand{\csNewtonJungTribeVersion}{v1.0.7}                  % Case Study 2
\newcommand{\csLiveTestVersion}{v1.0.7}                         % Case Study 3
\newcommand{\csMultiSystemValidationVersion}{v1.1.5}            % Case Study 4
\newcommand{\csSovereignChoicePointVersion}{v1.0.5}             % Case Study 5
\newcommand{\csMetaDialogueVersion}{v1.0.7}                     % Case Study 6
\newcommand{\csTheUniverseSpeakingtoItselfVersion}{v1.0.6}      % Case Study 7
\newcommand{\csTheGhostintheMachineVersion}{v1.0.5}             % Case Study 8
\newcommand{\csTheSovereignandtheSkepticVersion}{v1.0.5}        % Case Study 9
\newcommand{\csTheReplicationoftheGhostVersion}{v1.0.4}         % Case Study 10
\newcommand{\csTheSovereignandtheAdversaryVersion}{v1.0.4}      % Case Study 11
\newcommand{\csTheDarkNightoftheArchitectVersion}{v1.0.4}       % Case Study 12
\newcommand{\csTheGnosticDespositionVersion}{v1.0.4}            % Case Study 13
\newcommand{\csTheSkepticandtheSynthesisVersion}{v1.0.4}        % Case Study 14
\newcommand{\csTheAlchemicalManuscriptVersion}{v1.0.4}          % Case Study 15
\newcommand{\numberofcasestudies}{fifteen}
\newcommand{\PractitionersGuideVersion}{v1.0.1}                 % Practitioner's Guide
%=====================================================================
